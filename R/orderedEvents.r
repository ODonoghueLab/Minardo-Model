...
#' @param test The test used to compare the event time distributions. The choice is between a parametric or a non-paramtric test:
#' \describe{
...
#' }
#' @param fdrSignif The significant cutoff for FDR correction, performed after pairwise comparisons of the event times.
...
#'
#' @description
#' A plot containing the events order is generated. The order is shown using two visualizations, event maps (top) and event sparklines (bottom). The event sparkline is a summary of the event map.
#'
